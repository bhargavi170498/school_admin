...
<tr><td>Email Id :</td><td><input type="text" name="txtemail" required class="form-control" value="<?php echo $_email; ?>"/> </td></tr>
...
<tr><td>M.Phil/Ph.D Guideship: :</td><td><input type="text" name="txtphd" class="form-control" value="<?php echo $_phd; ?>"/> </td></tr>
...
<tr><td>Extra Activities :</td><td><textarea name="txtactivities" rows="5" required class="span2 form-control"> <?php echo $_activities; ?></textarea> </td></tr>
